...
private:
  ...
  mlir::Value mlirGen(ExprAST &expr) {
    switch (expr.getKind()) {
    case toy::ExprAST::Expr_BinOp://var c = a + b; %c = toy.add %a, %b : tensor<...>
      return mlirGen(cast<BinaryExprAST>(expr));
    case toy::ExprAST::Expr_Var://var c = a; %c = %a : tensor<...>
      return mlirGen(cast<VariableExprAST>(expr));
    case toy::ExprAST::Expr_Literal://var a<2, 3> = [[1, 2, 3], [4, 5, 6]];
      return mlirGen(cast<LiteralExprAST>(expr));
    case toy::ExprAST::Expr_Call://var c = multiply_transpose(a, b);
      return mlirGen(cast<CallExprAST>(expr));
    case toy::ExprAST::Expr_Num:// var a = 42.0;
